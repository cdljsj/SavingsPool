 ...
 */
 ...
 module.exports = {
   ...
   networks: {
     ...
     hecotest: {
       provider: () => new HDWalletProvider(process.env.mnemonic, `wss://ws-testnet.hecochain.com`),
       network_id: "256",
       timeoutBlocks: 200,
       confirmations: 2,
       gasPrice: 2000000000,
     ...
     heco: {
      provider: () => new HDWalletProvider(process.env.mnemonic, `wss://ws-mainnet.hecochain.com`),
